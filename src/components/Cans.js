...
export function Can({ position }) {
    ...
    var can_height = nodes.Object_2.geometry.boundingBox.max.y - nodes.Object_2.geometry.boundingBox.min.y;
    ...
    for (let i = count; i > 0; i--) {
        ...
        for (let j = 0; j < i; j++) {
            horizontal_cans.push(
                <mesh ref={ref} geometry={nodes.Object_2.geometry}
